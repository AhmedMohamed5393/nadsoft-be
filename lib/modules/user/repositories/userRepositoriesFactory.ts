...
export class UserRepositoriesFactory {
    ...
    public static get Instance() {
        return UserRepositoriesFactory.instance || (UserRepositoriesFactory.instance = new UserRepositoriesFactory());
    }
    ...
    private createRepositories() {
        this.repositoriesMap.set(UserRepository.name, new UserRepository());
    }
}
